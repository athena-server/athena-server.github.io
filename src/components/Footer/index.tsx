...
const Footer = ({
    ...
    return (
        <footer className="px-8 bg-[#202127] border-t border-white md:px-10">
            <div className="font-bold flex flex-wrap justify-center  items-center py-4 lg:justify-between">
                {/* Contact Detail */}
                <div className="flex flex-col mt-2 mb-8 md:flex-row md:space-x-5  md:mt-0  md:mb-0">
                    {[
                        {label:email, icon:"/Footer/mail.svg"},
                        {label:phone, icon:"/Footer/phone.svg"},
                        {label:location, icon:"/Footer/location.svg"},
                    ].map((item, index)=>(
                        <div key={index} className="flex md:justify-center items-center space-x-2 p-2">
                ...
                <div className="flex justify-center items-center mt-8 mb-6 md:mt-0 md:mb-0">
                    <p className="text-center">
                        Copyright &copy; {new Date().getFullYear()} CSED, 
